...
#     global master_time
#     t.clear()
#     master_time += 0.04  # Rotation speed
    
#     # 18 rings ka loop
#     for i in range(18):
#         # Rainbow color flow
#         hue = (i / 18 + master_time * 0.05) % 1
...
#             # Yahan hai asli Quantum Rotation (X aur Y ko rotate karna)
#             rot_x = (x * math.cos(master_time) - y * math.sin(master_time))
#             rot_y = (x * math.sin(master_time) + y * math.cos(master_time))
            
#             t.goto(rot_x * scale, rot_y * scale)
#             t.pendown()
